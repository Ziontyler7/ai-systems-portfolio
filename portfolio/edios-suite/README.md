...
Michael's role across the suite includes product strategy, systems architecture, product engineering, interaction design, technical documentation, evidence development, and release preparation.

## Applications

1. **Radius** — creator commerce and local-business platform
2. **Comedy Camera** — entertainment and performance platform
3. **Amateur Artist** — art discovery and gallery platform
...
## Evidence still pending structured archival

- exact TestFlight build numbers and dates for the original six applications;
- per-application technology stacks;
- formal test records;
- public-safe architecture diagrams;
- approved screenshot packages for permanent repository publication.

## Public boundary

This portfolio documentation excludes private source code, protected architecture, internal prompts, user data, API keys, infrastructure configuration, and unpublished implementation pathways.
