# Edios Suite Application Registry

| Order | Application | Public category | Public-safe purpose | Verified release status |
|---|---|---|---|---|
| 1 | Radius | Creator commerce and local business | Supports creators and local businesses with media, discovery, sales, and booking-oriented experiences | TestFlight beta |
| 2 | Comedy Camera | Entertainment and performance | Provides comedy and performance experiences, including general and youth-oriented stage concepts | TestFlight beta |
| 3 | Amateur Artist | Art discovery | Creates a discovery and gallery experience for emerging and unknown artists | TestFlight beta |
